...
namespace HabbitCracker.View.Menu
{
    ...
    public partial class DataBase : Page
    {
        ...
        private void SetItemSource()
        {
            ...
            HabbitGrid.ItemsSource = db.Habbits.Local.ToBindingList();
                    ...
                    case "HabbitGrid":
                        {
                            ...
                            {
                                Model.Entities.Habbit habbit = item.SelectedItems[i] as Model.Entities.Habbit;
                                if (habbit != null)
                                {
                                    db.Habbits.Remove(habbit);
                                }
                            }
                        }
                        break;
